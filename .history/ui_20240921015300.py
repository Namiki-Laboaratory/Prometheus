...
# If you want to do some changes you should change them in those panels.
    ...
    def draw(self, context):
        ...
        if self.props_general.bInPreview:
            ...
            column_back.operator(opt.OP_MainAction., icon='SCREEN_BACK', text='Back From Preview').action = 'BACK'
...
# Initial speed (float)
    ...
    def draw(self, context):
        ...
        layout.template_list(util.ui.UL_SelectCollectionForTrack.bl_idname, "UL_OBJ", 
