...
Main_Panel_Names = ["AutoDataset", "Object", "Material", "Light", "Camera", "Physics", "Movement"]

def SignRegisterProps_MainPanel(order:int):
    bl_order = order 
    bl_idname = PanelIDPrefix + Main_Panel_Names[bl_order]
    bl_label = Main_Panel_Names[bl_order]
    bl_parent_id = PanelIDPrefix + Main_Panel_Names[0]
...
# If you want to do some changes you should change them in those panels.
    ...
    bl_order, bl_idname, bl_label, _ = SignRegisterProps_MainPanel(0)
    bl_order = 0
    bl_idname = PanelIDPrefix + "Auto"
    ...
    def draw(self, context):
        ...
        column.prop(self.props_general, "bObjectsTrack2D")
        column.prop(self.props_general, "bDepth8bit")
        column.prop(self.props_general, "bDepthRaw")
...
# Initial speed (float)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(1)
...
# Random base PBR material (material parameter)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(2)
...
## maybe move lights?
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(3)
...
# Complex rate (int)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(4)
...
# Solver Iterations (int)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(5)
...
class P_Movement(P_Master):
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MainPanel(6)
