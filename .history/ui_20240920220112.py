...
class P_Annotation_Depth(P_Master):
    ...
    def draw_header(self, context: Context):
        self.layout.prop(self.props_annotation, 'bDepth',t)
...
AllPanelClasses = [P_General, P_Object, P_Material, P_Light, P_Camera, P_Physics, P_Movement, P_Annotation, P_Annotation_Track, P_Annotation_Depth]
