...
class UL_ShowAllTargetsWithProperty(bpy.types.UIList):
    ...
    property_holder : bpy.props.CollectionProperty
    ...
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname, index):
        ...
        for each_porp in self.Properties_show:
            split.prop(self.property_holder[item.name], each_porp, text="")


Reigster = [UL_SelectedTarget, UL_ShowAllTargetsWithProperty]