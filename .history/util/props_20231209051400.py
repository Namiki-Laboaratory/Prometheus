...
class TrackCollectionStructure(BaseUIListStructure):
    bTracked: BoolProperty(default=False)

class MaterialMeshStructure(BaseUIListStructure):
...
class PhysicObjectsStructure(BaseUIListStructure):
    Shape_Enu = [
...
class CameraCurvesStructure(BaseUIListStructure):
...
Register = [
    ...
    MaterialMeshStructure, 
    PhysicObjectsStructure, 
    CameraCurvesStructure,
