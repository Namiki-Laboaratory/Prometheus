...
class General(PropertyGroup):
    ...
    StartVideoIndex: IntProperty(name='Start Video Index', default=1, min=1, max=9999,
                                 update=lambda self, context : AmountCheck(self, 'StartVideoIndex', 'VideoNumber', context, bCheckMax=False))
    StartFrameIndex: IntProperty(name='Start Frame Index', default=1, min=1, max=999999,
                                 update=lambda self, context : AmountCheck(self, 'StartFrameIndex', 'VideoMaxFrame', context, bCheckMax=False))
...
class Movement(PropertyGroup):
    ...
    MaxVel: FloatProperty(name="Max Velocity", default=1, min=1, max=1024, 
                          update=lambda self, context: AmountCheck(self, 'MaxVel', 'MinVel', context, bCheckMax=True), unit='VELOCITY')
    MinVel: FloatProperty(name="Min Velocity", default=1, min=1, max=1024,
                          update=lambda self, context : AmountCheck(self, 'MinVel', 'MaxVel', context, bCheckMax=False), unit='VELOCITY')
