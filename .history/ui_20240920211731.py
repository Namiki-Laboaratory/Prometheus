...
Master_Panel_Names = ["AutoDataset", "Object", "Material", "Light", "Camera", "Physics", "Movement"]

def SignRegisterProps_MasterPanel(order:int):
    bl_order = order 
    bl_idname = PanelIDPrefix + Master_Panel_Names[bl_order]
    bl_label = Master_Panel_Names[bl_order]
    bl_parent_id = PanelIDPrefix + Master_Panel_Names[0]
...
# If you want to do some changes you should change them in those panels.
    ...
    bl_order, bl_idname, bl_label, _ = SignRegisterProps_MasterPanel(0)
...
# Initial speed (float)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(1)
...
# Random base PBR material (material parameter)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(2)
...
## maybe move lights?
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(3)
...
# Complex rate (int)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(4)
...
# Solver Iterations (int)
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(5)
...
class P_Movement(P_Master):
    ...
    bl_order, bl_idname, bl_label, bl_parent_id = SignRegisterProps_MasterPanel(6)
