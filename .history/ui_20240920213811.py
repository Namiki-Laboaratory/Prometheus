...
class P_Test(P_Master):
    bl_idname = PanelIDPrefix + "Test"
    bl_label = 'Test'
    bl_parent_id = PanelIDPrefix + "AutoDataset"
...
AllPanelClasses = [P_General, P_Object, P_Material, P_Light, P_Camera, P_Physics, P_Movement, P_General.P_Test]
