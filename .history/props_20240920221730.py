...
class Objects(PropertyGroup): 
    Collections: CollectionProperty(type=props.TrackCollectionListStructure)
...
class Material(PropertyGroup):
    SelectedMesh: CollectionProperty(type=props.MaterialMeshListStructure)
    Index: IntProperty(default=0, min=0)
...
class Camera(PropertyGroup):
    Curves: CollectionProperty(type=props.CameraCurvesListStructure)
    Index: IntProperty(default=0, min=0)
...
class Physics(PropertyGroup):
    SelectedObject: CollectionProperty(type=props.PhysicObjectsListStructure)
    Index: IntProperty(default=0, min=0)
...
AllPropClasses = [General, Objects, Material, Light, Camera, Physics, Movement, Annotation, Props_All]
