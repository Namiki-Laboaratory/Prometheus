...
class General(PropertyGroup):
    ...
    bObjectsTrack: BoolProperty(name="Tracking", default=True)
    bObjectsTrack2D: BoolProperty(name="Tracking 2D bounding boxes", default=True)

    bDepthInfo: BoolProperty(name="Random Seed", default=False)
    bDepth8bit: BoolProperty(name="Random Seed", default=True)
