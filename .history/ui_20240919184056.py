...
# If you want to do some changes you should change them in those panels.
    ...
    def draw(self, context):
        ...
        subcolumn.enabled = self.props_general.bObjectsTrack
        subcolumn.prop(self.props_general, "bObjectsTrack2D")

        column.prop(self.props_general, "bDepthInfo")
        subcolumn = column.column(align=True)
        subcolumn.enabled = self.props_general.bDepthInfo
        subcolumn.prop(self.props_general, "bDepth8bit")
