...
class AnnotationProcessor:
    ...
    def __init__(
        ...
        self.output_node = self.CreateOutputNode(self.scene, self.path)
...
class object_by_cryptomatte(AnnotationProcessor):
    def __init__(
        ...
        self.output_node = self.CreateOutputNode(self.scene, self.path_crypto)

    def CreateOutputNode(self, scene, path):
        output_node = super().CreateOutputNode(scene, path)
